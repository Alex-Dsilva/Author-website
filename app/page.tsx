...
export default function Home() {
  ...
  const [rating, setRating] = useState(5) // New state for interactive stars

  useEffect(() => {
    setTimeout(() => setPrice("$19.99"), 1500)
  }, [])

  return (
    // Base Theme matches the Book Cover colors perfectly
    <main className="bg-[#FDF8F4] text-[#402824] min-h-screen font-sans selection:bg-[#CB8D88] selection:text-white">
      
      <Navbar />

      {/* ================= 1. WELCOME PAGE (Curiosity & Thought) ================= */}
      <section id="welcome" className="min-h-screen flex flex-col items-center justify-center text-center px-6 pt-20 pb-12">
        ...
        {/* Author's thought to boost curiosity */}
        ...
        {/* Call to action pointing directly to About Me */}
      ...
      <section id="book" className="py-24 px-6 border-y border-[#C9A164]/20 bg-gradient-to-b from-[#FDF8F4] to-white">
        <div className="max-w-6xl mx-auto flex flex-col lg:flex-row items-center gap-12">
          ...
          {/* Framed 3D Book Hero with a beautiful glowing petal background */}
          ...
          <div className="w-full lg:w-1/2 flex flex-col items-center lg:items-start text-center lg:text-left">
            ...
            <div className="text-xl mb-8 font-serif text-[#402824]/60 uppercase tracking-widest">
              Current Price <span className="font-bold text-[#CB8D88] text-4xl ml-4 normal-case">{price}</span>
            </div>
      ...
      <section id="review" className="py-32 px-6 bg-white border-y border-[#C9A164]/20">
        <div className="max-w-6xl mx-auto">
          ...
          {/* New Review Form with Interactive Stars instead of a dropdown */}
              ...
              <div className="flex justify-center gap-2 mb-2">
                {[1, 2, 3, 4, 5].map((star) => (
                  <button 
                    ...
                    className={`text-4xl transition-colors ${rating >= star ? 'text-[#C9A164]' : 'text-[#C9A164]/30'}`}
                  >
                    ★
                  </button>
                ))}
        ...
        <div className="max-w-3xl mx-auto">
          ...
          <form className="flex flex-col sm:flex-row gap-0 max-w-lg mx-auto shadow-xl rounded-tl-[30px] rounded-br-[30px] overflow-hidden" onSubmit={(e) => e.preventDefault()}>
            <input 
              ...
              className="flex-1 px-6 py-5 bg-white border-none focus:outline-none font-serif placeholder-[#402824]/40"
              required
            />
